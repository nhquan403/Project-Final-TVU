...
> **TÀI LIỆU NÀY LÀ GÌ — VÀ KHÔNG PHẢI LÀ GÌ**
>
> Đây là bản **hướng dẫn thi công**: quyển báo cáo phải có gì, mỗi phần nằm ở
> tệp nào, cần chuẩn bị bao nhiêu hình và hình đó thể hiện điều gì, cùng danh
> sách việc còn lại trước khi nộp.
>
> **Đây KHÔNG phải đề cương đồ án.** Đề cương là văn bản nộp cho giảng viên
> hướng dẫn *trước* khi làm, gồm tên đề tài, lý do chọn, mục tiêu và câu hỏi
> nghiên cứu, đối tượng và phạm vi, phương pháp, dàn ý dự kiến và tiến độ. Đề
> cương nằm ở **`docs/de-cuong-do-an.md`**.
>
...
```
docs/
├── de-cuong-do-an.md          ← ĐỀ CƯƠNG nộp cho GVHD
├── huong-dan-lam-bao-cao.md   ← tài liệu này: hướng dẫn thi công
├── kich-ban-bao-ve.md         ← kịch bản nói khi bảo vệ
